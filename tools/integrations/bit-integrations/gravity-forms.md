...
Gravity Forms is a premium-only WordPress form plugin with advanced features including conditional logic, multi-page forms, payment integrations, and a large ecosystem of add-ons. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/Gravity_Forms1.svg`
...
- Payment completed (when using Gravity Forms payment add-ons)
...
After selecting Gravity Forms as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate Gravity Forms on your WordPress site.
...
5. Select Gravity Forms as the trigger.
