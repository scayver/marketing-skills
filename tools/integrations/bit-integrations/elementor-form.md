...
Elementor is the most popular WordPress page builder, and its Pro version includes a Form widget for building and embedding forms directly in page layouts. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** Yes
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/Elementor1.svg`
...
The Form widget requires Elementor Pro — it is not available in the free version of Elementor. Bit Integrations connects to the Elementor Pro form widget specifically.
...
After selecting Elementor Form as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate Elementor Pro on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a form using the Elementor Form widget and publish it on a page.
4. Go to Bit Integrations > Create Integration.
5. Select Elementor Form as the trigger.
