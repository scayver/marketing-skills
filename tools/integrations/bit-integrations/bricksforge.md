...
BricksForge is an advanced add-on for Bricks Builder that extends it with enhanced form capabilities, custom panels, animations, and additional design tools beyond the native Bricks feature set. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/BricksForge.svg`
...
After selecting BricksForge as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate Bricks Builder and BricksForge on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a form using BricksForge's enhanced form element in Bricks Builder and publish it on a page.
4. Go to Bit Integrations > Create Integration.
5. Select BricksForge as the trigger.
