...
WSForm is an advanced WordPress form builder with a spreadsheet-like field management interface, making it powerful for building complex, data-heavy forms with calculations and conditional logic. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/WSForm.svg`
...
After selecting WSForm as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate WSForm on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a form in WSForm and publish it on a page.
4. Go to Bit Integrations > Create Integration.
5. Select WSForm as the trigger.
