...
SiteOrigin Widgets Bundle is a collection of widgets for the SiteOrigin Page Builder, and it includes a contact form widget for embedding forms within SiteOrigin-powered layouts. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/SiteOrigin-Widgets-Bundle.svg`
...
After selecting SiteOrigin Widgets Bundle as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate SiteOrigin Widgets Bundle (and SiteOrigin Page Builder) on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a page with the SiteOrigin contact form widget and publish it.
4. Go to Bit Integrations > Create Integration.
5. Select SiteOrigin Widgets Bundle as the trigger.
