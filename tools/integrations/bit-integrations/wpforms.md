...
WPForms is a beginner-friendly drag-and-drop form builder for WordPress, available in a free Lite version and a premium Pro version. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** Yes
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/WPforms.svg`
...
After selecting WPForms as the trigger in Bit Integrations, connect it to any of these action platforms:
...
3. Create a form in WPForms and publish it on a page.
4. Go to Bit Integrations > Create Integration.
5. Select WPForms as the trigger.
