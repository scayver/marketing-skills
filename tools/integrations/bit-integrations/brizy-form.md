...
Brizy is a WordPress page builder with a clean visual editing experience, and its Form element allows building forms directly within Brizy layouts. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/BrizyForm1.svg`
...
After selecting Brizy Form as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate Brizy on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a page with a form element in Brizy and publish it.
4. Go to Bit Integrations > Create Integration.
5. Select Brizy Form as the trigger.
