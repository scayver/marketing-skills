...
Kali Forms is a WordPress form builder plugin with a drag-and-drop interface, conditional logic, and integrations with popular email marketing and CRM tools. Available as a Trigger in the Bit Integrations WordPress plugin — fires a workflow when a form is submitted.

**Role:** Trigger
**Free Tier:** No
**Category:** Form Builders
**Icon:** `https://bit-integrations.com/wp-content/uploads/2026/02/Kali-Forms.svg`
...
After selecting Kali Forms as the trigger in Bit Integrations, connect it to any of these action platforms:
...
1. Install and activate Kali Forms on your WordPress site.
2. Install and activate Bit Integrations (free from wordpress.org/plugins/bit-integrations/).
3. Create a form in Kali Forms and publish it on a page.
4. Go to Bit Integrations > Create Integration.
5. Select Kali Forms as the trigger.
